...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins ZedboardOLED_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ZedboardOLED_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins ZedboardOLED_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ZedboardOLED_0/S00_AXI/S00_AXI_reg] SEG_ZedboardOLED_0_S00_AXI_reg
...
preplace port VBAT -pg 1 -y 230 -defaultsOSRD
preplace port SCLK -pg 1 -y 170 -defaultsOSRD
preplace port DC -pg 1 -y 190 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port SDIN -pg 1 -y 150 -defaultsOSRD
preplace port VDD -pg 1 -y 250 -defaultsOSRD
preplace port RES -pg 1 -y 210 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 350 -defaultsOSRD
preplace inst ZedboardOLED_0 -pg 1 -lvl 3 -y 200 -defaultsOSRD
...
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 440 300 740
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 250 420 30 740
preplace netloc ZedboardOLED_0_RES 1 3 1 NJ
levelinfo -pg 1 0 220 590 850 970 -top 0 -bot 440
",
}
